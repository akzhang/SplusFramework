...
@interface QutoPayHome ()

@end

@implementation QutoPayHome
...
- (void)viewDidLoad
{
    ...
    _imageNameArray = [NSArray arrayWithObjects:@"splus_alipay_app", @"splus_alipay_web", @"splus_post", @"splus_credit", nil];
    
    _imageNameArrayCh = [NSArray arrayWithObjects:@"splus_alipay_app_choose", @"splus_alipay_web_choose", @"splus_credit_choose", @"splus_credit_choose",nil];
